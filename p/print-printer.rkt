...
(module+ main
  ...
  (command-line
   #:program "printers management"
   #:args (command)
   (case command
     [("list") (view-printers-list)]
     [else
      (displayln "printers: excepts 1 <command> one of the following")
      (displayln "list --- View list of the available printers")])))
