...
(define pavlovsk-document-filename (build-path mama-directory
                                               "found-garbage-in-pavlovsk.pdf"))
...
(define/contract (print-pavlovsk amount-of-docs amount-of-maps)
  (-> (and/c number? positive?) (and/c number? positive?) boolean?)
  (printf "Print main document, ~a times\n" amount-of-maps)
  (2side-print-file pavlovsk-document-filename amount-of-docs))
